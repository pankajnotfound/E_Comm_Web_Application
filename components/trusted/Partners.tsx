  ...
  return (
    <div className='flex flex-col gap-10'>
        ...
        <div className='w-full flex flex-wrap gap-15 justify-center items-center '> 
            <Link href='/' className='w-fit flex gap-5 justify-center items-center transition-all duration-300 ease-in-out rounded p-2 hover:text-white hover:bg-[var(--primary)] hover:-translate-y-1 '>
