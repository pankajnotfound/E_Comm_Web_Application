    ...
    <div className='w-screen h-screen flex justify-center items-center bg-linear-to-tl from-[var(--third)] to-[var(--text_color)] '>
      <div className='w-[60%] h-[70%] flex bg-white rounded-xl shadow-[0px_0px_20px_5px_gray] '>
        <div className='w-[50%] h-full flex-col flex justify-center items-center gap-5 border-r-1 border-gray-400'>
          ...
          <p className='text-xl text-[var(--text_color)] font-semibold text-center'>BECOME A SUPPLIER TODAY AND START EXPANDING YOUR BUSINESS DIGITALLY</p>
        </div>
        <form className='w-[50%] flex flex-col justify-center items-center p-4 gap-5'>
          <p className='text-3xl font-semibold pb-5'>Register as a Vendor</p>
          <input type="text" required placeholder='Username' className='w-[80%] h-10 bg-gray-100 rounded-lg p-5' />
          ...
          <input type="text" required placeholder='Confirm Password' className='w-[80%] h-10 bg-gray-100 rounded-lg p-5' />
