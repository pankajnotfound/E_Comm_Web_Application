  ...
  return (
    <div className=' w-full h-fit p-40 bg-[var(--secondary)] flex flex-col gap-10 justify-center items-start '>
      ...
      <div className='w-full flex flex-wrap gap-10 p-10 justify-center items-center '>
        <Link href='/products' className='w-[48%] bg-[var(--primary)] flex flex-nowrap justify-center items-center gap-10 p-5 py-20 rounded-2xl shadow-[0px_0px_20px_1px_gray] transition-all duration-300 ease-in-out hover:bg-[var(--third)] hover:text-white '>
        ...
        <Link href='/uploadproduct' className='w-[48%] bg-[var(--primary)] flex flex-nowrap justify-center items-center gap-10 p-5 py-20 rounded-2xl shadow-[0px_0px_20px_1px_gray] transition-all duration-300 ease-in-out hover:bg-[var(--third)] hover:text-white '>
          <FontAwesomeIcon icon={faSearchPlus} className='!w-15 !h-15 p-4' />
          <p className='text-3xl font-semibold p-4 place-self-center'>Upload Product</p>
        </Link>
        <Link href='/becomevendor' className='w-[48%] bg-[var(--primary)] flex flex-nowrap justify-center items-center gap-10 p-5 py-20 rounded-2xl shadow-[0px_0px_20px_1px_gray] transition-all duration-300 ease-in-out hover:bg-[var(--third)] hover:text-white '>
        ...
        <Link href='/myorders' className='w-[48%] bg-[var(--primary)] flex flex-nowrap justify-center items-center gap-10 p-5 py-20 rounded-2xl shadow-[0px_0px_20px_1px_gray] transition-all duration-300 ease-in-out hover:bg-[var(--third)] hover:text-white '>
        ...
        <Link href='/trackorder' className='w-[48%] bg-[var(--primary)] flex flex-nowrap justify-center items-center gap-10 p-5 py-20 rounded-2xl shadow-[0px_0px_20px_1px_gray] transition-all duration-300 ease-in-out hover:bg-[var(--third)] hover:text-white '>
        ...
        <Link href='/contactsupport' className='w-[48%] bg-[var(--primary)] flex flex-nowrap justify-center items-center gap-10 p-5 py-20 rounded-2xl shadow-[0px_0px_20px_1px_gray] transition-all duration-300 ease-in-out hover:bg-[var(--third)] hover:text-white '>
